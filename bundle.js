var app = (function () {
  ...
  function Re(e) {
    return e.replace(
      /{{\s*([a-zA-Z0-9_]+)\s*}}/g,
      '<span class="env-variable">$1</span>'
    );
  }
  class qe {
    constructor(e) {
      ...
      p(e, a) {
        if (e.data) {
          ...
          for (n = a.data.rows, i = 0; i < n.length; i += 1) {
            ...
            r[i]
              ? r[i].p(e, o)
              : ((r[i] = Ge(o)), r[i].c(), r[i].m(t.parentNode, t));
          }
      ...
      p(e, a) {
        if (e.reqData || e.getClassForStatusCode || e.hljs) {
          ...
          for (n = a.reqData.exampleResponses, i = 0; i < n.length; i += 1) {
            ...
            r[i]
              ? r[i].p(e, o)
              : ((r[i] = rt(o)), r[i].c(), r[i].m(t.parentNode, t));
          }
          for (; i < r.length; i += 1) r[i].d(1);
          r.length = n.length;
        }
    ...
    return {
      c() {
        (t = h("div")),
          ...
          _(
            p,
            "class",
            (b = l(e.request.method.toLowerCase()) + " svelte-akvaw2")
          ),
      ...
      p(e, t) {
        (V && !e.request) || i === (i = t.request._id) || _(r, "id", i),
          ...
          (V && !e.request) ||
            b === (b = l(t.request.method.toLowerCase()) + " svelte-akvaw2") ||
            _(p, "class", b),
  ...
  class ot extends re {
    constructor(e) {
      super(),
        ne(this, e, it, at, o, ["request", "env", "language", "cookiejars"]);
    }
  }
  function st(e, t) {
    return e
    ...
    return (
      ...
      (e.$$.update = (e = { group: 1, env: 1, groupData: 1 }) => {
        (e.group || e.env) &&
          n(
            "groupData",
            (a = { name: st(o.name, s), description: st(o.description, s) })
          ),
          e.groupData &&
      ...
      p(e, n) {
        if (e.content || e.env || e.language || e.cookiejars) {
          ...
          for (r = n.content, o = 0; o < r.length; o += 1) {
            ...
            a[o]
              ? (a[o].p(e, i), Z(a[o], 1))
              : ((a[o] = ft(i)), a[o].c(), Z(a[o], 1), a[o].m(t.parentNode, t));
          }
  ...
  class _t extends re {
    constructor(e) {
      super(),
        ne(this, e, bt, mt, o, ["content", "env", "language", "cookiejars"]);
    }
  }
  function vt(t) {
    var n,
  ...
  const kt = ({ row: e, visible: t, hoverItemIndex: n }) => ({
      item: t,
      i: t,
      hoverItemIndex: n,
    }),
    xt = ({ row: e, visible: t, hoverItemIndex: n }) => ({
      item: e.data,
      i: e.index,
      hoverItemIndex: n,
    });
    ...
    var t,
      ...
      r = new Lt({
        props: {
          ...
          $$slots: {
            default: [Tt, ({ item: e, i: t }) => ({ item: e, i: t })],
          },
          $$scope: { ctx: e },
        },
      });
    ...
    function o(e) {
      return {
        props: {
          ...
          isFirst: zt(e.i),
          isActive: qt(e.item, e.selectedValue, e.optionIdentifier),
          isHover: Dt(e.hoverItemIndex, e.item, e.i, e.items),
        },
      };
    }
      ...
      p(n, r) {
        ...
        if (
          ...
          (n.item || n.selectedValue || n.optionIdentifier) &&
            (a.isActive = qt(e.item, e.selectedValue, e.optionIdentifier)),
          (n.hoverItemIndex || n.item || n.i || n.items) &&
            (a.isHover = Dt(e.hoverItemIndex, e.item, e.i, e.items)),
          i !== (i = e.Item))
        ) {
          if (s) {
            W();
        ...
        p(e, n) {
          if (
            ...
            for (r = n.items, o = 0; o < r.length; o += 1) {
              ...
              a[o]
                ? (a[o].p(e, i), Z(a[o], 1))
                : ((a[o] = Ht(i)), a[o].c(), Z(a[o], 1), a[o].m(t, null));
            }
            for (W(), o = r.length; o < a.length; o += 1) i(o);
            J();
          }
      ...
      p(r, a) {
        ...
        if (
          ...
          (r.items || r.selectedValue || r.optionIdentifier) &&
            (i.isActive = qt(e.item, e.selectedValue, e.optionIdentifier)),
          (r.hoverItemIndex || r.items) &&
            (i.isHover = Dt(e.hoverItemIndex, e.item, e.i, e.items)),
          o !== (o = e.Item))
        ) {
          if (l) {
            W();
      ...
      p(e, t) {
        if (
          ...
          for (r = t.selectedValue, i = 0; i < r.length; i += 1) {
            ...
            a[i]
              ? a[i].p(e, o)
              : ((a[i] = Jt(o)), a[i].c(), a[i].m(n.parentNode, n));
          }
      ...
      (e.$$.update = (
        ...
        (e.groups || e.requests) && n("content", (i = [...c, ...u])),
          (e.workspace || e.env) &&
            n(
              "description",
              (o = d.description && r.makeHtml(st(d.description, l)))
            ),
    ...
    return (
      ...
      (e.$$.update = (e = { config: 1, envId: 1 }) => {
        (e.config || e.envId) && n("env", (s = r.environments[a])),
          (e.config || e.envId) &&
            n("requests", (l = pn(r.requests, r.environments[a]))),
          (e.config || e.envId) &&
            n("groups", (c = pn(r.groups, r.environments[a])));
      }),
      {
        config: r,
        envId: a,
        ...
        toggleExample: function () {
          n("exampleVisible", (d = !d)),
            localStorage.setItem("show-examples", d);
        },
        env: s,
        requests: l,
        groups: c,
  ...
  function jn(e) {
    if (
      ...
      (function (e) {
        return (
          "symbol" == typeof e || (Pn(e) && "[object Symbol]" == Cn.call(e))
        );
      })(e)
    )
      return e;
  ...
  var Nn,
    ...
    Rn =
      ...
      function () {
        for (
          var e = arguments, t = -1, n = Tn(e.length - Hn, 0), r = Array(n);
          ++t < n;
  ...
  function Dn(e) {
    ...
    return (
      ...
      (e.description = e.description.replace(qn, "")),
      e
    );
  }
  class Bn {
